...
(1, 'tomate', 100, 2000, 1, 1, '1', '2025-03-10', 1, '2025-03-27', 7, 9, 1),
(3, 'huevo', 100, 600, 4, 30, 'AAA', '2025-03-24', 1, '2025-03-24', 7, 9, 1);
...
INSERT INTO `productos_subcategorias` (`subCat_id`, `prod_id`, `subCat_categoria`, `subCat_fechaCreacion`) VALUES
(1, 1, 'por defecto', '2025-03-29 03:39:32'),
(2, 3, 'JUMBO', '2025-03-29 03:48:45');
...
ALTER TABLE `carrito_tiene_productos`
  ...
  ADD CONSTRAINT `carrito_tiene_productos_ibfk_3` FOREIGN KEY (`prod_id`) REFERENCES `productos` (`prod_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `productos`
  ...
  ADD CONSTRAINT `productos_ibfk_5` FOREIGN KEY (`subCat_id`) REFERENCES `productos_subcategorias` (`subCat_id`) ON DELETE CASCADE ON UPDATE CASCADE;
