...
// for (let i = 0; i < 30; i++) {
    ...
    // web.loginModal.showModal();
    // busca informacion sobre las medidas
...
// BillModal.showModal();
// WebPage.showLoadingModal("cargando espera un poco pendejo");
// billPreviewModal.showModal();
// document.getElementById('allCategory').click = true;
...
//  $("#alertUserName_alert").text(user.name);
// orderLimitNotification.showModal();
